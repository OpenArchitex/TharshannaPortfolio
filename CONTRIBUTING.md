...
1.  **Start developing.**
   ...
   Navigate into your clone directory (we will call it `TharshannaPortfolio`) and start it up.

   ```shell
   cd TharshannaPortfolio/
   gatsby develop
   ```
...
1.  **Open the source code and start editing!**
   ...
   Open the `TharshannaPortfolio` directory in your code editor of choice and edit `src/pages/index.js`. Save your changes and the browser will update in real time!
